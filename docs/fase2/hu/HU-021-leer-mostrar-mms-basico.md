...
> **Nota:** Esta HU fue arrastrada de la Fase 1 (Sprint 5+). Se incluye en la Fase 2 como punto de partida del Sprint 6.
...
**Dependencias:** HU-013 (Pantalla de conversación con burbujas)
...
- [ ] Los MMS enviados (desde nuestra app) no se implementan en esta HU — solo lectura
